...
While the Standard Model predicts the nEDM to be below \SI{e-30}{\elementarycharge\centi\meter}, its extensions foresee it to be in the \SIrange[range-phrase = --]{e-29}{e-22}{\elementarycharge\centi\meter} range \note{cite for the lower range}. Also, the neutron EDM, provides the most sensitive handle on measurement of the on $\theta_\text{QCD}$.
