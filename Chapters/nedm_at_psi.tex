...
Would be here a good place to lay the structure of the thesis? I could mention the importance of the stability of the magnetic fields---hence the SFC, and then mention about all the exotic physics that has been tested using the nEDM data---hence the axions. Make it another section!