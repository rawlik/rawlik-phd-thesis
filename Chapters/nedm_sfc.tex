...
Pseudo-inverting a matrix with small singular values is an ill-posed problem.
Similarly, as inverting small numbers.
...
The effect is, that the noise in the original matrix becomes amplified by the condition number in the pseudoinverse.
...
Figure~\ref{fig:nEDM_SFC_svd} presents the spectrum of the PSI's SFC feedback matrix.
