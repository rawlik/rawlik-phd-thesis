...
Per-cycle sensitivity in the order of \SI{e-24}{\elementarycharge\centi\meter}
The gap in Fig.\,\ref{fig:nEDM_measurement_principle}:
\begin{equation}
  \Delta_{E\uparrow\downarrow} = 4 d_n E = \SI{4e-24}{\elementarycharge\centi\meter} \ \frac{ \SI{132}{\kilo\volt} }{ \SI{12}{\centi\meter} } = \SI{4.4e-20}{\electronvolt}
\end{equation}
\begin{equation}
  \mu_n = \SI{-9.7e-27}{\joule\per\tesla} = \SI{-6e-8}{\electronvolt\per\tesla}
\end{equation}
\begin{equation}
  \Delta B = \frac{ \Delta_{E\uparrow\downarrow} }{2 \mu_n} = \SI{3.7e-13}{\tesla} = \SI{370}{\femto\tesla}
\end{equation}



\SI{e-27}{\elementarycharge\centi\meter}



Now the importance of the magnetic field stability! Also, as a break in reading. Show the magnetic field scale plot? Maybe not, but at least say how little is the measurement goal in teslas.

What countermeasures are taken? First, the mu-metal shield. A bit on the mu-metal, that it needs to be degaussed, for example.
