...
The mapping of the Area South in the UCN hall at PSI, the location of the nEDM and n2EDM experiments, took place in the days 18--22.12.2017 and 2--12.01.2017. In that time the nEDM apparatus has already been disassembled and a reinforced concrete foundation for the n2EDM experiment has been laid. After the n2EDM apparatus is set up it will occupy the area and no magnetic mapping will be possible. The goal of the mapping campaign was to characterise the magnetic field environment. Of particular interest were the nearby strong magnets. It was mainly done for the active magnetic field compensation system, as necessary input for coil design.
...
The volume to map was much larger then in LPSC and the device needed to be enlarged. The `L-piece' was enlarged to \ldots. The tower was \SI{8}{\metre} high. An additional sensor was added directly above the floor. The other elements, string potentiometers, magnetic field sensors and DAQ, remained the same. \note{get the geometry}
...
There were three strong magnets close to the area: COMET, SULTAN and COBRA\@. COMET is a medical cyclotron located several meters into the concrete biological shielding on the far-side wall in Fig.\,\ref{fig:mapping_photo}. Its field, very inhomogeneous due to the vicinity of the source, was around \SIrange[range-phrase=--,range-units=single]{10}{80}{\micro\tesla} strong. COMET was very rarely turned off. Fortunately, during the mapping campaign there was scheduled power-cut for which COMET was turned off. It made it possible to measure its field, too. SULTAN is a superconducting magnet for material research located around \SI{15}{\metre} \note{verify} away from the site. It ramps daily, creating a roughly \SI{50}{\micro\tesla} field in the area. COBRA is a magnet located in a neighbouring experimental hall. The strength of its field is around \SI{5}{\micro\tesla}.

In total \note{list of maps} maps were taken with various combinations of the magnets. They are summarised in Tab.\,\ref{tab:psi_mapping_maps}. As of April 2018 the analysis of this maps in ongoing.~\cite{EmmeneggerThesis}. They will provide an input to decide which coils of the cartesian harmonics are going to be built, or even dedicated ones, and what remnant field may be expected.

\begin{table}
  \centering
  \begin{tabular}{ccccc}
    date & time & COMET & SULTAN & COBRA \\ \midrule
    xxx & xxx & 1 & 1 & 0 \\
    xxx & xxx & 1 & 1 & 0 \\
    xxx & xxx & 1 & 1 & 0 \\
    % 1 & 1 & 0 & 0 \\
