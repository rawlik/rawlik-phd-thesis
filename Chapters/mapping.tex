...
$x_0 = 0$, $y_0 = \SI{1871}{\milli\metre}$, and the third potentiometer was in the point $(\SI{1756}{\milli\metre}, 0$. $a = \SI{623}{\milli\metre}$.

A photograph of the mapping setup is shown in Fig.\,\ref{fig:mapping_bastille_setup}. The mobile \SI{2.5}{\metre} high tower was equipped with ten 3-axis fluxgate magnetic field sensors. The model was Stefan-Mayer FLC3--70, the same as used in the active magnetic field stabilisation system. The stationary `L-piece' held three string potentiometers, Micro-Eplison WDS-15000-P115-SA-P with \SI{15}{\metre} extension range, spanned to the tower. The string potentiometers were equipped with custom made attachments that allowed the string to come at an angle out of the device. The point where the strings bent was taken to be the middle of the circle in the geometry solution.
...
The data acquisition system, pictured in Fig.\,\ref{fig:mapping_bastille_daq}, consisted of: a power supply that put a constant voltage on the potentiometers; a custom-built crate for the fluxgates, which supplied them with power and conditioned the incoming signals; and a National Instruments PXI crate, which simultaneously digitised the analogue voltage signals from the fluxgates and the string-pots. The data were collected on a PC computer.
...
\begin{figure}
  ...
  \caption{The map of the magnitude of the magnetic field. Each tile depicts a horizontal plane, the field measured by one magnetic sensor. On the ceiling there are small strong sources of the magnetic field and the colour scale is saturated.}\label{fig:mapping_bastille_magnitude}
\end{figure}
...
\begin{figure}
  ...
  \caption{Left: Reproducibility of the field, std is \SI{138}{\nano\tesla}. Right: reproducibility of the gradient estimation, std is \SI{3.8}{\nano\tesla\per\centi\metre}}\label{fig:mapping_bastille_reproducibility}
\end{figure}
