...
\begin{figure}
  ...
  \caption{A map of the magnetic field in one plane, height around \note{HEIGHT} above the floor. \note{Get a plot from Solange with the outline of the hall marked, or make one myself. The trace of the tower should be marked there, too!}}\label{fig:mapping_p-i_map}
\end{figure}
