...
\begin{figure}
  ...
  \note{Make the figures nicely match. It seems both are for 50uT. Maybe even make a direct comparison? Rather not, but at least make the same size and the scales match.}
...
In the CAD model of the n2EDM experiment a cage for the compensation coils has been included. It was designed in a way The opening size around 1.5m has been designed \note{get a nice picture from Michi}. It was then implemented in the coil-design framework. Fig.\,\ref{fig:n2EDM_design_top}.
