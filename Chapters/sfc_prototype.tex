...
A second solution was to have a removeable face without connectors: cancelling currents along one edge.

The third was to design a system with one face left open. The immediate advantage of demonstrating the power of the coil design method.


The next iteration is designed with one face (rectangular one, $Y-$) left open. Designed fully following the algorithm.

\note{Need a nice figure with the coil design marked, somehow\ldots Draw by hand first!}
