...
Predefined grid, can deal with spatial constrained. Shared between different coils - can built many ones. In particular, it is possible to construct coils for the mutually orthogonal terms of the Cartesian 
