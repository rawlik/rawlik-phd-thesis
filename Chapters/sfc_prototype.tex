...
We have just discussed how the active shield can stabilise the magnetic field in the case of strong variations. However, the system's internal stability was inevitably finite. In conditions, where the environmental magnetic field would be more stable than than, the system would effectively destabilise the field. In this section we will discuss where the limit of the stability was.
...
The open-design $y$-coil was a significant step forward from the the closed-cage design. It has been demonstrated that the coil design framework is capable of handling irregular grids, and the designs can be successfully realised in practice. While the prototype at ETH could be further extended by winding the remaining seven coils, the positive results of the $y$-coil already supported the case for designing a system for the n2EDM experiment.
...
Remnant fields this small are unlikely to be the limiting factor in the dynamic stabilisation. Recall the discussion at the end of Sec.\,\ref{sec:dynamic_stabilisation}, in particular Fig.\,\ref{fig:prototype_compensation}. The ability of the prototype to actively shield was limited by the high order of the field changes. The homogeneity of the zeroth order coils of the n2EDM active shield's design as comparable to the ones of the prototype: \SIrange[range-phrase=--,range-units=single]{1}{2}{\percent}. Therefore, the limit in the shielding factor is expected to be similar: around 50.



This of course depends on how thie field looks like. 


In reality the remnant field is expected to be larger.

The remnant field in reality is likely to be dominated by the high-order field, or something like that.


These numbers are small enough for the shielding factor to be rather limited by the shape of the field than the accuracy of the coils in reproducing the field.
% It is below \SI{15}{\micro\tesla} ~\cite{Franke2013}

It would be much better than the typical remnant of \SI{10}{\micro\tesla} in the nEDM experiment.

The simulations show that an active shield for the n2EDM experiment is realistic.




An active magnetic shield for the n2EDM experiment based on the presented grid. It is supported by both simulations and practical demonstrations with the ETH prototype is realistic.

We presented the designs for the homogeneous fields

Here the designs for the homogeneous fields and linear gradients were presented. It whether it is a good choice for the specific magnetic conditions 

Mapping, discussed in the next chapter.
