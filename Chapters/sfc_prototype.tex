...
The active shield was tested with strong, inhomogeneous disturbances; its long-term stability was also tested.
...
At ETH Zürich a system pictured in Fig.\,\ref{fig:prototype_photo} was built consisting of a $5 \times 9 \times 5$ grid of square tiles. Each tile had side length \SI{262}{\milli\meter} and the total size was $1310 \times 1310 \times \SI{2358}{\milli\meter}$.
...
To support the cable channels, on each side a large one-piece aluminum sheet was attached, with square cut-outs leaving material only directly below the cable channels.
...
\begin{figure}
  ...
  \caption{The reaction of the active magnetic field compensation to a step change in the magnetic field ($\approx \SI{30}{\micro\tesla}$ in \SI{5}{\milli\second}). The system was running at a rate of \SI{200}{\hertz}. Each dot marks one iteration.
  Only one measurement channel is plotted.}\label{fig:prototype_step_response}
\end{figure}
...
The amplitude of the variations seen in Fig.\,\ref{fig:prototype_compensation_time} can be quantified as the difference between 75th and 25th quantiles of all the measurement points projected on the $y$-axis.
...
Figure\,\ref{fig:prototype_stability} features a red line labeled ``\SI{50}{\ohm} ADC short circuit''.
...
\begin{figure}
  ...
  The borders of the plots correspond to the surface on which the coils are wound.
...
The main point of concern was the spatial constraints.
...
\begin{figure}
  ...
  \caption{The quality of the field produced by the coils designed for the n2EDM experiment, quantified by a histogram of the deviation of the design's simulated field from the target one, as calculated on the surface of the mu-metal shield.
...
When canceling a perfectly homogeneous \SI{50}{\micro\tesla} field the remnant is expected to be $< \SI{1}{\micro\tesla}$ (which corresponds to \SI{2}{\percent}).
