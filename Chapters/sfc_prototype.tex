...
\begin{figure}
  \centering
  \includegraphics[width=0.75\linewidth]{gfx/prototype/big_magnet_performance_shielding_factor.pdf}
...
\begin{figure}
  ...
  \caption{\ldots}\label{fig:prototype_open_design_Ycoil_map_section}
\end{figure}
