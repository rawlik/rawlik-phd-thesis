...
\begin{figure}
  ...
  \emph{Top row:} Depiction of a coil designed to produce a \SI{50}{\micro\tesla} homogeneous field along $x$, left-to-right on the plot ($n=1$, cf.\ Tab.\,\ref{tab:coils_cartesian_harmonics}).
