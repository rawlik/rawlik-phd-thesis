...
To support the cable channels, on each side attached was a large one-piece aluminum sheet, with square cut-outs leaving material only directly below the cable channels.
