...
The simulated field produced by the optimal designs for the $x$-coil and $n = 5$ (Tab.\,\ref{tab:coils_carthesian_harmonics}) are presented in Fig.\,\ref{fig:prototype_open_design_simulation}.
...
In the CAD model of the n2EDM experiment a cage for the compensation coils has been included. It was composed out of rectangles maximally around \SI{1.5}{\metre} large. The cage, depicted in Fig.\,\ref{fig:n2EDM_design_top}, was then implemented in the coil-design framework.

A set of coils has been designed for the (Tab.\,\ref{tab:coils_carthesian_harmonics})
...
\begin{figure}
  ...
  \caption{\ldots}\label{fig:n2EDM_design_deviation}
\end{figure}
