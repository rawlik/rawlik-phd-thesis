...
\begin{sidewaysfigure}
  ...
  On the top view the other projections are defined (the names have a geographical origin).
  ...
  The volume of interest used in the optimisation---in green.}\label{fig:n2EDM_design_top}
\end{sidewaysfigure}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{gfx/prototype/n2EDM_simulation.pdf}
  ...
  The section in the XY plane at height $z=\SI{4.5}{\meter}$ above the floor is shown.
  \emph{Top row:} Depiction of a coil designed to produce a homogeneous field along $x$, left-to-right on the plot ($n=1$, cf.\ Tab.\,\ref{tab:coils_cartesian_harmonics}).
  \emph{Bottom row:} The field of coil for the $n=6$ linear gradient.}\label{fig:n2EDM_design_fields}
\end{figure}
