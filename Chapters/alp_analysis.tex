...
\begin{figure}
  ...
  \caption{The data taking scheme in the nEDM experiment at PSI\@. \note{Make a new figure, still hand-drawn, but nicer. Check the colouring scheme for the field polarity. Don't do subfigures---put everything one with an inset.}}\label{fig:oscillating_nEDM_in_R}
\end{figure}
