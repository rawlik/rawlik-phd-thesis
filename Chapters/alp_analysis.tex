...
In order to perform a \SIrange[range-phrase=--]{3}{300}{\hertz} scan in a 1000 cycles (3 days of operation for the nEDM at PSI experiment) the width of the resonance would need to be
\begin{equation}
...
\begin{figure}
  ...
  \caption{\ldots}\label{fig:axions_prediction}
\end{figure}
