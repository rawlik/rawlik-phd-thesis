...
\marginpar{Sidereal frequency is one of the Earth's spinning as seen in the reference of distant stars.}
...
\begin{figure}
  ...
  \caption{\cite{Romalis2009_NF}}\label{fig:axions_wind_limits}
\end{figure}
