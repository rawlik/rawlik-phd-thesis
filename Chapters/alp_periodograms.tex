...
For the sake of pedagogy we will first discuss the methodology on a simple example.
...
Many packages offer the possibility to readily calculate Lomb--Scargle periodograms (\url{https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.lombscargle.html#scipy.signal.lombscargle} , \url{http://docs.astropy.org/en/stable/stats/lombscargle.html} , \url{http://lombscarglejl.readthedocs.io/en/latest/}). It could not be used directly, as the analysis deviated in details from the standard procedure.

We will follow an analisis of a simple example, shown in Fig.\,\ref{fig:basic_signal}.
